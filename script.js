...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ==========================================
  // HUGGING FACE API & CHAT LOGIC (Moved inside listener)
  // ==========================================
  // Solution : Utilisation du chemin relatif /api/chat. 
  // Cela fonctionne quel que soit le domaine, car le Worker intercepte cette route.
